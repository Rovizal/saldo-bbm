	...
	<div class="sidebar-content">
		...
		<div class="card card-sidebar-mobile">
			<ul class="nav nav-sidebar" data-nav-type="accordion">
				<li class="nav-item">
					<a href="<?= base_url('sopir/dashboard'); ?>" class="nav-link <?= ($this->router->fetch_class() == 'dashboard') ? 'active' : '' ?>">
						<i class="icon-home4"></i>
						<span>Dashboard</span>
					</a>
				</li>
				<li class="nav-item">
					<a href="<?= base_url('sopir/mobil'); ?>" class="nav-link <?= ($this->router->fetch_class() == 'mobil') ? 'active' : '' ?>">
						<i class="icon-car"></i>
						<span>Daftar Mobil</span>
					</a>
				</li>
				<li class="nav-item">
					<a href="<?= base_url('sopir/request'); ?>" class="nav-link <?= ($this->router->fetch_class() == 'request') ? 'active' : '' ?>">
						<i class="icon-clippy"></i>
						<span>Request</span>
					</a>
				</li>
				<li class="nav-item">
					<a href="<?= base_url('sopir/activity'); ?>" class="nav-link <?= ($this->router->fetch_class() == 'activity') ? 'active' : '' ?>">
