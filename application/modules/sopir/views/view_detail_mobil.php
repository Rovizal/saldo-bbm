		...
		<div class="content">
			<div class="card">
				<div class="card-header">
					<a href="<?= base_url('sopir/mobil') ?>" class="btn btn-primary btn-sm"><i class="icon-arrow-left7"></i> Kembali</a>
				</div>
				<div class="card-body">
					<div class="row mb-3">
						...
						<div class="col-md-6">
							...
							<p class="mb-0" style="font-size:40px;font-weight:bold;color:#007bff"><?= $liter_per_100km ?> liter / 100km</p>
...
<!-- /page content -->
<?php $this->load->view('script/mobil_sopir_detail_script'); ?>
