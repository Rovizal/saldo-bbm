<script>
	...
	function loadHistory() {
		tbl_history_mobil = $('#tbl_history_mobil').DataTable({
			...
			// "responsive": true,
			"ajax": {
				url: "<?= base_url('admin/mobil/get_history_mobil_datatable?data=') ?>" + base64UrlSafeEncode(idMobil),
				dataType: "json",
				type: "GET",
				dataSrc: "data",
			},
	...
	function loadActivity() {
		tbl_activity = $('#tbl_activity').DataTable({
			...
			"pageLength": 10,
			"ajax": {
				url: "<?= base_url('admin/mobil/get_perjalanan_datatable') ?>?data=" + base64UrlSafeEncode(idMobil),
				dataType: "json",
				type: "GET",
				dataSrc: "data"
			},
